...
public class EntityFissionMissile extends EntityProjectile
{
	private float power = 160F;
	public final static EntityType<?> type = EntityRegistry.FISSIONMISSILE;
	public Entity thrower = this.getShooter();


	public EntityFissionMissile(World worldIn)
	{
		super(type, worldIn);
		this.world = worldIn;
	}

	public EntityFissionMissile(World worldIn, LivingEntity throwerIn)
	{
		super(type, worldIn);
		this.world = worldIn;
	}

	public EntityFissionMissile(World worldIn, LivingEntity throwerIn, float power)
	{
		super(type, worldIn);
		this.world = worldIn;
		this.power = power;
	...
	public EntityFissionMissile(World worldIn, double x, double y, double z)
	{
		super(type, worldIn);
		this.world = worldIn;
	}

	public EntityFissionMissile(World worldIn, double x, double y, double z, float power)
	{
		super(type, worldIn);
		this.world = worldIn;
		this.power = power;
