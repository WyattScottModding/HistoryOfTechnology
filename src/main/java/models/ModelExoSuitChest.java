...
public class ModelExoSuitChest extends BipedModel
{
	RendererModel Back1;
	RendererModel Back2;
	RendererModel Back3;
	...
	public ModelExoSuitChest()
	{
		...
		ShoulderRight3.addBox(5F, -2F, 0F, 3, 1, 3);
		ShoulderLeft3.addBox(-5F, -2F, 0F, 3, 1, 3);
		ShoulderRight4.addBox(5F, -2F, 0F, 1, 1, 2);
		ShoulderLeft4.addBox(-5F, -2F, 0F, 1, 1, 2);
		ArmRight.addBox(5F, -2F, 0F, 1, 10, 2);
		ArmLeft.addBox(-5F, -2F, 0F, 1, 10, 2);
		CuffRight1.addBox(5F, -2F, 0F, 1, 1, 4);
		CuffLeft1.addBox(-5.0F, -2.0F, 0.0F, 1, 1, 4);
		CuffRight2.addBox(5F, -2F, 0F, 1, 1, 4);
		CuffLeft2.addBox(-5.0F, -2.0F, 0.0F, 1, 1, 4);
		CuffRight3.addBox(5F, -2F, 0F, 6, 1, 1);
		CuffLeft3.addBox(-5.0F, -2.0F, 0.0F, 6, 1, 1);
		CuffRight4.addBox(5F, -2F, 0F, 6, 1, 1);
		CuffLeft4.addBox(-5.0F, -2.0F, 0.0F, 6, 1, 1);

		ShoulderLeft2.setRotationPoint(4F, -1F, 2F);
		ShoulderRight3.setRotationPoint(-7F, -1F, -1F);
		ShoulderLeft3.setRotationPoint(4F, -1F, -1F);
		ShoulderRight4.setRotationPoint(-8F, -1F, -1F);
		ShoulderLeft4.setRotationPoint(7F, -1F, -1F);
		ArmRight.setRotationPoint(-9F, -1F, -1F);
		ArmLeft.setRotationPoint(8F, -1F, -1F);
		CuffRight1.setRotationPoint(-9F, 9F, -2F);
		CuffLeft1.setRotationPoint(8F, 9F, -2F);
		CuffRight2.setRotationPoint(-4F, 9F, -2F);
		CuffLeft2.setRotationPoint(3F, 9F, -2F);
		CuffRight3.setRotationPoint(-9F, 9F, -3F);
		CuffLeft3.setRotationPoint(3F, 9F, -3F);
		CuffRight4.setRotationPoint(-9F, 9F, 2F);
