...
{
	protected final Item item = ItemInit.THROWING_KNIFE;
	private final net.minecraft.client.renderer.ItemRenderer itemRenderer;

	public RenderKnife(EntityRendererManager renderManagerIn, net.minecraft.client.renderer.ItemRenderer itemR)
	{
	...
	public ItemStack getStackToRender(EntityKnife entityIn)
	{
