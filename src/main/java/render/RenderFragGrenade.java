...
@OnlyIn(Dist.CLIENT)
public class RenderFragGrenade extends EntityRenderer<EntityFragGrenade>
{
	protected final Item item = ItemInit.FRAGGRENADE;
	private final net.minecraft.client.renderer.ItemRenderer itemRenderer;

	public RenderFragGrenade(EntityRendererManager renderManagerIn, net.minecraft.client.renderer.ItemRenderer itemR)
	{
