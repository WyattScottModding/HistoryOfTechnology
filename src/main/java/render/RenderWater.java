...
@OnlyIn(Dist.CLIENT)
public class RenderWater extends EntityRenderer<EntityWater>
{
	public static final ResourceLocation TEXTURES = new ResourceLocation(Reference.MODID + ":textures/entity/entitywater.png");

	protected final Item item = ItemInit.WATER;
	private final net.minecraft.client.renderer.ItemRenderer itemRenderer;

	public RenderWater(EntityRendererManager renderManagerIn, net.minecraft.client.renderer.ItemRenderer itemR)
	{
	...
	public ItemStack getStackToRender(EntityWater entityIn)
	{
